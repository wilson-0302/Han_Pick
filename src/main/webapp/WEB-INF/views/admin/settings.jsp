    ...
    <div class="flex-grow-1 d-flex flex-column overflow-hidden">
        ...
        <header class="topbar d-flex align-items-center justify-content-between px-3 px-md-4 py-3">
            <div class="d-flex align-items-center gap-3">
                ...
                <h5 class="mb-0 d-none d-sm-block">설정</h5>
            </div>
        ...
        <div class="flex-grow-1 overflow-auto p-3 p-md-4">
            <div class="container-fluid" style="max-width: 1000px;">
                <div class="card-dark rounded-4 p-4">
                    <h6 class="fw-bold mb-4 text-white d-flex align-items-center gap-2">
                        <span class="material-symbols-outlined text-primary">settings</span>시스템 설정
                    </h6>
                    <div class="d-flex flex-column gap-4">
                        <div>
                            <label class="form-label text-white fw-semibold mb-2">시스템 정보</label>
                            <div class="card-dark rounded-3 p-3">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <span class="text-secondary-custom">서버 상태</span>
                                    <span class="badge bg-success">정상</span>
                                </div>
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <span class="text-secondary-custom">데이터베이스</span>
                                    <span class="badge bg-success">연결됨</span>
                                </div>
                                <div class="d-flex justify-content-between align-items-center">
                                    <span class="text-secondary-custom">버전</span>
                                    <span class="text-white">v1.0.0</span>
                                </div>
                            </div>
                        </div>
                        <div>
                            <label class="form-label text-white fw-semibold mb-2">관리자 계정</label>
                            <div class="card-dark rounded-3 p-3">
                                <div class="mb-2">
                                    <span class="text-secondary-custom small">아이디: </span>
                                    <span class="text-white">admin</span>
                                </div>
                                <div>
                                    <span class="text-secondary-custom small">권한: </span>
                                    <span class="text-white">최고 관리자</span>
                                </div>
                            </div>
                        </div>
                    </div>
